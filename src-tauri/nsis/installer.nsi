...
; Uninstaller Pages
; 1. Confirm uninstall page (custom page with editable path + Browse button)
Var DeleteAppDataCheckbox
Var DeleteAppDataCheckboxState
Var UninstallDirField
Var BrowseBtn
!define /ifndef WS_EX_LAYOUTRTL         0x00400000

UninstPage custom un.PageConfirm un.PageConfirmLeave
...
Function un.OnBrowse
  ...
  ${AndIf} $0 != ""
    StrCpy $INSTDIR $0
    ${NSD_SetText} $UninstallDirField $0
  ${EndIf}
FunctionEnd

Function un.PageConfirmLeave
  ${NSD_GetText} $UninstallDirField $0
  ${If} $0 != ""
    StrCpy $INSTDIR $0
  ${EndIf}
